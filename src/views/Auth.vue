<template>
  <v-container class="info lighten-2" :fill-height="!isMobile" fluid>
            ...
            <v-window-item :value="1">
              <v-row>
                <v-col cols="12" md="10">
                  <v-card-text>
                    <h3
                      class="text-center text-lg-h3 primary--text text--accent-3 text-uppercase"
                    >
                      Connectez-vous
                    </h3>
                    <p class="text-center grey--text">
                      Entrez vos informations d'identification pour acceder à
                      votre compte
                    </p>
                    <v-form class="mx-4">
                      <v-row dense>
                    ...
                    <p class="text-center mb-0">
                      <a href="#" class="accent--text text-accent-3">
                        Mot de passe oublié ?
                      </a>
                    </p>
                  </v-card-text>
                ...
                >
                  <v-col
                    :class="
                      isMobile
                        ? 'white--text py-2 px-0 text-center'
                        : 'white--text text-center vertical'
                    "
                  >
                    <v-icon
                      v-if="!isMobile"
                    ...
                    <div class="pb-4 px-1" style="font-size: 12px">
                      s'enregistrer <small class="pa-0 ma-0"> </small>
                    </div>
                  </v-col>
                </v-col>
              </v-row>
                      ...
                      <v-row dense>
                        <v-col cols="12">
                          <v-text-field
                            v-model="username"
                            color="primary"
                            hint="ne peut contenir que des lettres, des nombres ou les caractères « @ », « . », « + », « - » et « _ »."
                            label="Nom d'utilisateur"
                            prepend-icon="mdi-account"
                          />
                        </v-col>
                        ...
                        <v-col cols="12">
                          <v-text-field
                            v-model="password"
                            color="primary"
                            hint="doit êtres un mot de passe valide et contenir au moins 8 caractères "
                            label="Mot de passe"
                            prepend-icon="mdi-lock"
                            type="password"
                          />
                        ...
                        <v-col>
                          <v-text-field
                            ...
                            hint="Le même mot de passe saisi dans le champs précédent."
                            color="primary"
