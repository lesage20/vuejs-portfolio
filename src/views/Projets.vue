                            ...
                            <v-card-text>
                                ...
                                <div class="mt-2">
                                    <v-row justify="space-between" class="my-1 px-4">
                                        <h4 class="d-flex success--text"> {{Math.floor(projet.progression)}}% Terminée</h4>
                                        <h4 class="d-flex warning--text"> {{Math.floor(projet.buffer - projet.progression)}}% En cours</h4>
                                        <h4 class="d-flex"> {{Math.floor(100 - projet.buffer)}}% En attente</h4>
                                    </v-row>
